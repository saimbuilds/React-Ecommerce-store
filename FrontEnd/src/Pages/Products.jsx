...
const Products = () => {
  ...
  const renderProduct = products.map((product)=>{
    return (
      ...
      <div className='w-[20%]  h-auto bg-blue-100 text-black p-2 rounded-xl flex flex-col gap-4'>
  ...
  return (
    <>
     {products.length>0?<div className='bg-gray-800 flex flex-wrap gap-20 p-4 mt-10'>{renderProduct}</div>:"loading..."}
    </>
  )
}
